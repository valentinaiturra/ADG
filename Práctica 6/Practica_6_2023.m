...
axis tight
grid on
legend('Datos originales','Ventana de 12','Ventana de 31','Ventana de 61','Location','best')
...
axis tight
grid on
legend('Original','Rectangular','Triangular','Gaussiano','Location','best')
...
legend('Datos originales','Comando filtfilt','Comando filter','Location','best')
xlabel('Tiempo [Años]')
